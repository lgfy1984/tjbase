			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearch" align="center">
				...
				<tr>
					<td>
						...
						级别：
						<input name="levelFlag" type="text" onkeypress="eventOnKeyPress('parentId')" value="${dataForm.levelFlag}" />
			...
			<table width="100%" align="center" class="tblScrollFooter" align="center">		
				<tr>
					...
					%>				
						...
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/security/securityConfigPublicClass.do?verbId=queryDetail" />
