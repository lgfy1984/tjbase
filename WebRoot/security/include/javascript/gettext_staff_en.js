...
//			}
			...
			*/
			...
			if(check=="getPeople"){
				document.getElementById("div_pinyin").innerHTML = '<div class="writediv"><select id="inputTypeId" style="width:70px;margin-right:10px;"><option value="1">Phonetic code</option><option value="2">Health personnel code</option><option value="3">Chinese character</option></select>Query：<input type="hidden" id="hidden_value" value="" /><input type="text" name="divInputName" id="input_value" class="write_input" value="" onkeyup="findNames(\''+url+'\',\''+displayInputId+'\',\''+hiddenInputId+'\');" maxlength="30" /><input type="button" class="button" value="Selected" onclick="xuanz(\''+displayInputId+'\',\''+hiddenInputId+'\');" /></div><div id="guoji_div"><table id="guoji_table" border="0" cellspacing="1" cellpadding="0"><tr class="pinyin_nav"><td width="">Health personnel code</td><td width="">Phonetic code</td><td width="">Name</td></tr><tbody id="guoji_body"></tbody></table></div>';		
			}else{
				document.getElementById("div_pinyin").innerHTML = '<div class="writediv"><select id="inputTypeId" style="width:70px;margin-right:10px;"><option value="1">Phonetic code</option><option value="2">Code</option><option value="3">Name</option></select>Query：<input type="hidden" id="hidden_value" value="" /><input type="text" name="divInputName" id="input_value" class="write_input" value="" onkeyup="findNames(\''+url+'\',\''+displayInputId+'\',\''+hiddenInputId+'\');" maxlength="30" />&nbsp;<input type="button" width="90px" value="Selected" onclick="xuanz(\''+displayInputId+'\',\''+hiddenInputId+'\');" /></div><div id="guoji_div"><table id="guoji_table" border="0" cellspacing="1" cellpadding="0"><tr class="pinyin_nav"><td width="">Code</td><td width="">Phonetic code</td><td width="">Name</td></tr><tbody id="guoji_body"></tbody></table></div>';		
			}
