     ...
     function setNames(names,displayInputId,hiddenInputId) {            
       ...
       　　　　　　　　　　　　　　　　　　　　//设置显示位置
        ...
        for(var i=0 ;i < elementroot.length;i++){
        	...
        	var resItemCode = "";
        	var resItemCodeNode =  ress.getElementsByTagName("resItemCode")[0].firstChild;
        	if(resItemCodeNode!=null){
        		resItemCode = ress.getElementsByTagName("resItemCode")[0].firstChild.data;
        	}
