			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearchList" align="center">
				<caption style="text-align:left;">
   				...
   				<tbody id="interval_row_id">
   					<%
					if (dataForm.getModCodeList() != null) {
			...
			<table width="100%" align="center" class="tblScrollFooter">
				<tr>
					...
					%>
						...
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/security/securityConfigPublic.do?verbId=queryDetail" />
