	...
	<body onload="showMessage('<%=data.getMessage() %>')">
		...
		<form name="form" method="post"
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearch" align="center">
				<tr>
					<td class="tblTitle" colspan="4">
						<bean:message key="security.jsp.securityConfigParamClassProject.list.title" bundle="security"/>
					</td>
				</tr>
				<tr>
					<td>
						代码:
						<input name="projectCode" type="text" onkeypress="eventOnKeyPress('projectName')" value="<%=data.getProjectCode()%>" />
						
						名称:
					    <input name="projectName" type="text"  onkeypress="eventOnKeyPress('inputCode')" value="<%=data.getProjectName()%>" />
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearchList" align="center">
				...
				<thead>
			    	<tr class="lstName">
			            <th width="5%" height="26">工程代码<div><img src="include/images/cmdOrderByAsc.gif" alt="Ascender" vspace="7" onclick="commandOrderBy('1', '0')" /><img border="0" onclick="commandOrderBy('1', '1')" alt="Descender" src="include/images/cmdOrderByDesc.gif" /></div></th>
			            <th width="15%" height="26">工程名称<div><img src="include/images/cmdOrderByAsc.gif" alt="Ascender" vspace="7" onclick="commandOrderBy('2', '0')" /><img border="0" onclick="commandOrderBy('2', '1')" alt="Descender" src="include/images/cmdOrderByDesc.gif" /></div></th>
			            <th width="5%" height="26">输入码<div><img src="include/images/cmdOrderByAsc.gif" alt="Ascender" vspace="7" onclick="commandOrderBy('3', '0')" /><img border="0" onclick="commandOrderBy('3', '1')" alt="Descender" src="include/images/cmdOrderByDesc.gif" /></div></th>
			            <th width="4%" height="26">序号<div><img src="include/images/cmdOrderByAsc.gif" alt="Ascender" vspace="7" onclick="commandOrderBy('4', '0')" /><img border="0" onclick="commandOrderBy('4', '1')" alt="Descender" src="include/images/cmdOrderByDesc.gif" /></div></th>
				...
				<tbody id="interval_row_id">
					...
					<tr>
						...
						<td>
							<img onClick="cmdView('<%=data.getProjectCodeList()[i] %>')"
			...
			<table width="100%" align="center" class="tblScrollFooter">
				<tr>
					...
					%>
						<input type="hidden" id="pageId" name="pageId" value="page_2828810b3711d1b5013711d1b5250000" />
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/security/securityConfigParamProject.do?verbId=query"  />
