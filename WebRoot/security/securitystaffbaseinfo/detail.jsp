	...
	<body>
		<form name="form" method="post" action="security/securityStaffBaseinfo.do">
			...
			<div class="btnSave" id="btnSave">
				<input type="button"  name="btnBack" value="<bean:message key="security.jsp.commom.button2" bundle="security"/>" onclick="document.form.message.value='';history.go(-1);document.form.message.value='';" />
