...
<html>
	<head>
		...
		%>
		<title><bean:message key="security.jsp.securityconfigmenusadd.title" bundle="security"/></title>
...
function saveForm(){
	...
	<body onload="showCommMessage('','${dataForm.message}','1')">
		<form name="form" method="post" action="security/securityConfigMenus.do">
			<input type="hidden" name="verbId" value="add" />
			<table border="0" cellspacing="1" cellpadding="0" class="table">
				<tr>
					<td height="30px" class="biaoti" colspan="4">
						<font color="red">※</font>&nbsp;&nbsp;<bean:message key="security.jsp.securityconfigmenusadd.title" bundle="security"/>&nbsp;&nbsp;
						<font color="red">※</font>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="hou" nowrap>
						 <select class="select" id="parentId" name="data.parentId" onkeypress="eventOnKeyPress('picPath')">
							<option value=""></option>
				...
				<tr>
					...
					<td class="hou" nowrap>
						<select class="select" id="securityConfigPublicId" name="data.securityConfigPublicId" onkeypress="eventOnKeyPress('picPath')">
							<option value=""></option>
							<logic:iterate id="commBean" name="dataForm" property="securityConfigPublicList" indexId="ind">
								<option value="${commBean.id}">
									${commBean.reason}
								</option>
							</logic:iterate>
