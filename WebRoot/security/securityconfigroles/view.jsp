...
<head>
<title><bean:message key="security.jsp.securityConfigroles.view.title" bundle="security"/></title>
...
<div align="center"><html:form action="/securityConfigRoles.do">
	...
	<table width="829" border="0" cellspacing="1" cellpadding="0" class="table">
		<tr>
			<td colspan="4" class="list_nav"><bean:message key="security.jsp.securityConfigroles.view.title" bundle="security"/></td>
		</tr>
		<tr>
			<td class="name"><bean:message key="security.jsp.commom.roleCode" bundle="security"/>：</td>
			<td class="value"><tj:write property="data.roleCode"/></td>
			<td class="name"><bean:message key="security.jsp.commom.roleDetail" bundle="security"/>：</td>
			<td class="value"><tj:write property="data.roleDetail" /></td>
		</tr>
		<tr>
