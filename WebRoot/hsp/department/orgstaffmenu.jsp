		...
		function OnRightClick(event, treeId, treeNode) {
			if (!treeNode && event.target.tagName.toLowerCase() != "button" && $(event.target).parents("a").length == 0) {
				...
				if(treeNode.rMenuFlag=="1"){
				    ...
				    showRMenu3("node", $(document).scrollLeft()+event.clientX, $(document).scrollTop()+event.clientY);
			...
			<table>
			    <tr>
			        ...
			        <td align="left">
			            ...
			            <input type="text" id="itemName" name="itemName" size="22" value="${dataForm.itemName}"
