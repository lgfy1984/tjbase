...
<html>
	<head>
		<base href="<%=basePath%>">
		<title><bean:message  bundle="hsp.hspLocale" key="hsp.jsp.hspconfigbaseinfoimport.itemExcelImpData"/></title>
	...
	<body onload="showImportReport()">
		<center>
			<form name="form" action="<%=basePath%>hsp/hspConfigBaseinfo.do?verbId=elsImport" method="post" enctype="multipart/form-data">
			...
			<div id="reportDiv">
				...
				<div align="left">
					...
					<img src="<%=basePath%><bean:message  bundle="hsp.hspLocale" key="hsp.img.hspConfigBaseinfoExcelImportDemo.path"/>">
				</div>
			</div>
		</center>
	</body>
