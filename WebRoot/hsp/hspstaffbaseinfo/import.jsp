...
<html>
	...
	<body onload="showImportReport()">
		<center>
			<form name="form" action="<%=basePath%>hsp/hspStaffBaseinfo.do?verbId=elsImport" method="post" enctype="multipart/form-data">
			...
			<div id="reportDiv">
				...
				<div align="left">
					...
					<img src="<%=basePath%><bean:message  bundle="hsp.hspLocale" key="hsp.img.hspStaffBaseinfoExcelImportDemo.path"/>">
				</div>
			</div>
		</center>
	</body>
