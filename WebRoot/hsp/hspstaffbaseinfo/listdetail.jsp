		...
		<table width="100%" align="center" class="tblScrollFooter">
			<tr>
				...
				<script type="text/javascript">
					if(parent != null && parent.document.getElementById("iframe1") != null){
						document.write("<tr>");
						document.write("<td colspan=\"5\" align=\"center\" bgcolor=\"#ffffff\" class=\"btnSave\">");
						document.write("<input type=\"button\"  value=\"关闭\" onclick=\"closeIframe()\" />");
						document.write("</td>");
						document.write("</tr>");
					}
				</script>
