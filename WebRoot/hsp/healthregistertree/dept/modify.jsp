...
<html>
	...
	<body>
		<form name="form" method="post" action="<%=request.getContextPath()%>/hsp/healthRegisterTree.do">
			...
			<input type="hidden" id="hspId" name="deptBean.hspId"  value="<%=Converter.toBlank(deptBean.getHspId()) %>"/>
			<input type="hidden" id="hspName" name="deptBean.hspConfigBaseinfoName" value="<%=Converter.toBlank(deptBean.getHspConfigBaseinfoName()) %>" />
			<input type="hidden" id="deptCode" name="deptBean.deptCode" value="<%=Converter.toBlank(deptBean.getDeptCode()) %>" /> 
			<table border="0" cellpadding="0" cellspacing="0" class="tblFill" align="center">
				<tr>
					<td class="tblTitle" colspan="4">
					    <span>※</span>科室信息维护<span>※</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
				    ...
				    <td style="text-align: left">
				        <%=Converter.toBlank(deptBean.getDeptCode()) %>	
				    </td>
