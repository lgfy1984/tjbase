...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form name="form"
				...
				<tr>
					...
					<td class="hou">
						<c:forEach items="${dataForm.commConfigDegreeIdList}"
							...
							<logic:equal name="dataForm" value="${commConfigDegreeIdList.itemCode}"
			...
			<div
				style="width: 803px; padding-top: 5px; padding-right: 5px; line-height: 30px; text-align: right;" id="creat">
