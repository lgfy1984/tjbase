...
//			}
			...
			*/
			div_pinyin.innerHTML = '<div class="writediv"><select id="inputTypeId" style="width:70px;margin-right:10px;"><option value="1">Phonetic code</option><option value="2">PMI</option><option value="3">los caracteres chinos</option></select>Query:<input type="hidden" id="hidden_value" value="" /><input type="text" name="divInputName" id="input_value" class="write_input" value="" onkeyup="findNames(\''+url+'\',\''+displayInputId+'\',\''+hiddenInputId+'\');" maxlength="30" /><input type="button" class="button" value="selected" onclick="xuanz(\''+displayInputId+'\',\''+hiddenInputId+'\');" /></div><div id="guoji_div"><table id="guoji_table" border="0" cellspacing="1" cellpadding="0"><tr class="pinyin_nav"><td width="80">Name</td><td width="90">Sex</td><td width="166">Date of birth</td></tr><tbody id="guoji_body"></tbody></table></div>';		
