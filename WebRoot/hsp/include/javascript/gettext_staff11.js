...
//			}
			...
			*/
			var check=path.substring((path.length-12),path.length);
			if(check=="getAllPeople"){
				document.getElementById("div_pinyin").innerHTML = '<div class="writediv"><select id="inputTypeId" style="width:70px;margin-right:10px;"><option value="1">拼音码</option><option value="2">居民编号(PMI)</option><option value="3">汉字</option></select>查询条件：<input type="hidden" id="hidden_value" value="" /><input type="hidden" id="itemCode_value" value="" /><input type="text" name="divInputName" id="input_value" class="write_input" value="" onkeyup="findNames(\''+url+'\',\''+displayInputId+'\',\''+hiddenInputId+'\',\''+code1111+'\');" maxlength="30" /><input type="button" class="button" value="选中" onclick="xuanzss(\''+displayInputId+'\',\''+hiddenInputId+'\',\''+code1111+'\');" /></div><div id="guoji_div"><table id="guoji_table" border="0" cellspacing="1" cellpadding="0"><tr class="pinyin_nav"><td width="115">居民编号(PMI)</td><td width="85">拼音码</td><td width="136">名称</td></tr><tbody id="guoji_body"></tbody></table></div>';	
			}
			else{
				document.getElementById("div_pinyin").innerHTML = '<div class="writediv"><select id="inputTypeId" style="width:70px;margin-right:10px;"><option value="1">拼音码</option><option value="2">代码</option><option value="3">汉字</option></select>查询条件：<input type="hidden" id="hidden_value" value="" /><input type="hidden" id="itemCode_value" value="" /><input type="text" name="divInputName" id="input_value" class="write_input" value="" onkeyup="findNames(\''+url+'\',\''+displayInputId+'\',\''+hiddenInputId+'\',\''+code1111+'\');" maxlength="30" /><input type="button" class="button" value="选中" onclick="xuanzss(\''+displayInputId+'\',\''+hiddenInputId+'\',\''+code1111+'\');" /></div><div id="guoji_div"><table id="guoji_table" border="0" cellspacing="1" cellpadding="0"><tr class="pinyin_nav"><td width="80">代码</td><td width="90">拼音码</td><td width="166">名称</td></tr><tbody id="guoji_body"></tbody></table></div>';		
			}
