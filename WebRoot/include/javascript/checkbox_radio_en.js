...
function checkcell()
{
     ...
     if(!re.test(code))
     {
        alert("Enter the phone number is invalid");
   ...
   function checkdate()
{
     ...
     if(!re.test(date))
     {
         alert("Or date format such as 2007-01-01 2007-1-1");
...
function checknumber(idName)
{
      ...
      if(re.test(num))
      {
         alert("Only as an integer number!");
...
function checkchinese(idName)
{
      ...
      if(!re.test(num))
      {
         alert("Can only form of Chinese characters!");
         document.getElementById(idName).value="";
         return ;
      }
} 
...
function  checkPostCode(id){
   ...
   if(value!=null && value!=""){
    if(!ref.test(value)){
       alert(value+"Zip format is not correct!");
...
function  check4year(id){
    ...
    var value=document.getElementById(id).value;
      if(value!=null && value!=""){
    if(!ref.test(value)){
       alert(value+"Is not the correct year in the form!");
       document.getElementById(id).value="";
       return;
    }
    var saat=new Date();
...
function  check3Code(id){
    ...
    var value=document.getElementById(id).value;
   			if(value!=null && value!=""){
    if(!ref.test(value)){
       alert(value+"Is not the right code in the form!");
       document.getElementById(id).value="";
       return;
    }
    }
