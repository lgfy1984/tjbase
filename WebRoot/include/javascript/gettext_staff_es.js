...
//			}
			...
			*/
			...
			document.getElementById("div_pinyin").innerHTML = '<div class="writediv"><select id="inputTypeId" style="width:70px;margin-right:10px;"><option value="1">el código fonético</option><option value="2">el código</option><option value="3">los caracteres chinos</option></select> pregunta:<input type="hidden" id="hidden_value" value="" /><input type="text" name="divInputName" id="input_value" class="write_input" value="" onkeyup="findNames(\''+url+'\',\''+displayInputId+'\',\''+hiddenInputId+'\');" maxlength="30" />&nbsp;<input type="button" class="button" value="seleccionando" onclick="xuanz(\''+displayInputId+'\',\''+hiddenInputId+'\');" /></div><div id="guoji_div"><table id="guoji_table" border="0" cellspacing="1" cellpadding="0"><tr class="pinyin_nav"><td width="80">el código</td><td width="90">el código fonético</td><td width="166">nombre</td></tr><tbody id="guoji_body"></tbody></table></div>';		
