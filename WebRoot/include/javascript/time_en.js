...
write("<B style='cursor:hand; font: bold 14 Times New Roman' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=0'>Today:"+giYear+"Year"+giMonth+"Month"+giDay+"Day</B>");
write("</TD></TR>");
write("</TABLE></Div>");
