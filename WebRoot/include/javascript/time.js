...
function arrowtag(namestr,valuestr,size){
   istr=unescape('%u25bc');          
   document.write("<input type='text' name='"+namestr+"' readonly value='"+valuestr+"' size='"+size+"' class='s01'><input style='font-size:8pt;font-family:宋体����;' type='button' value='"+istr+"'onclick='fPopCalendar("+namestr+","+namestr+");return false'>");
  }
