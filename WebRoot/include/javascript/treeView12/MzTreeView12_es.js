...
function MzTreeView(Tname)
{
  if(typeof(Tname) != "string" || Tname == "")
    throw(new Error(-1, 'Por favor cree una instancia de clase, cuando una referencia al nombre de la clase variable de instancia pasado pulg！'));
...
MzTreeView.prototype.focus = function(sourceId, defer)
{
  ...
  if(path[0]!="0")
  {
    alert("nodo"+ sourceId +" No ancle correcto en el nodo efectivo de árbol！\r\n"+
      "Identificación del nodo de secuencia = "+ path.join(this.divider));
    return;
  }
