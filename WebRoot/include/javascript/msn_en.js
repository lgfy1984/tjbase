...
//    table1.style='BORDER-TOP: #ffffff 1px solid; BORDER-LEFT: #ffffff 1px solid';
    var str = "<DIV style='BORDER-RIGHT: #455690 1px solid; BORDER-TOP: #a6b4cf 1px solid; Z-INDEX: 99999; LEFT: 0px; BORDER-LEFT: #a6b4cf 1px solid; WIDTH: " + w + "px; BORDER-BOTTOM: #455690 1px solid; POSITION: absolute; TOP: 0px; HEIGHT: " + h + "px; BACKGROUND-COLOR: #c9d3f3'>"  
        ...
        str += "<TD style='PADDING-LEFT: 4px; FONT-WEIGHT: normal; FONT-SIZE: 14px;font-family:arial; COLOR: #1f336b; PADDING-TOP: 4px' vAlign=center width='100%'>" + this.caption + "</TD>"  
        str += "<TD style='PADDING-RIGHT: 2px; PADDING-TOP: 2px' vAlign=center align=right width=19>"  
        str += "<SPAN title='close' style='FONT-WEIGHT: bold; FONT-SIZE: 14px; CURSOR: pointer; COLOR: red; MARGIN-RIGHT: 4px';font-family:arial id='btSysClose'>×</SPAN></TD>"  
        str += "</TR>"  
        str += "<TR>"  
        ...
        str += "<DIV style='overflow:hidden;word-wrap:break-word; height:25px;' align=left><A href='javascript:void(0)' hidefocus=true id='consulCommand'><FONT color=#ff0000;font-family:arial;FONT-SIZE: 14px;>" +this.consultation + "</FONT></A></DIV>" 
        str += "</DIV>"  
        str += "</TD>"  
        str += "</TR>"  
        str += "</TABLE>"  
