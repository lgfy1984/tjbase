...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><bean:message key="include.jsp.error.operationErr" bundle="conf.include.include"/></title>
		<style type="text/css">
.js_table {
...
.js_nav {
	background: url(<%=request.getContextPath()%>/include/images/trbg.gif ) repeat-x 0 0;
	text-align: left;
	padding-left: 10px;
	height: 25px;
	line-height: 25px;
					...
					<table border="0" align="center" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="270" align="left" class="error">
								...
								<p class="margin_b">
									<bean:message key="include.jsp.error.operationFail" bundle="conf.include.include"/>
								</P>
								<p>
									Sorry，
								</P>
								<p class="margin_b">
									Your options  is  fail！
								</P>
