			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearch" align="center">
				<tr>
					<td class="tblTitle" colspan="4">
						<bean:message key="comm.jsp.common.relation" bundle="conf.comm.Comm"/>
					</td>
				</tr>
				<tr>
					<td>
						<bean:message key="comm.jsp.common.item" bundle="conf.comm.Comm"/>：
						<input name="itemCode" type="text" onkeypress="eventOnKeyPress('itemName')" value="<%=commConfigRelationship.getItemCode()%>">
					
						<bean:message key="comm.jsp.common.names" bundle="conf.comm.Comm"/>：
						<input name="itemName" type="text" onkeypress="eventOnKeyPress('inputCode')" value="<%=commConfigRelationship.getItemName()%>">
					
						<bean:message key="comm.jsp.common.inputItemCode" bundle="conf.comm.Comm"/>：
						<input name="inputCode" type="text" value="<%=commConfigRelationship.getInputCode()%>" onkeypress="eventOnKeyPress('btnSearch')">
				...
				<tbody id="interval_row_id">
					...
					<tr>
						<td style="text-align:left;padding-left:10px;">
							<%=commConfigRelationship.getItemCodeList()[i]%>
						</td>
						<td style="text-align:left;padding-left:10px;">
							<%=commConfigRelationship.getItemNameList()[i]%>
						</td>
						<td style="text-align:left;padding-left:10px;">
							<%=commConfigRelationship.getSeqNoList()[i]%>
						</td>
						<td style="text-align:left;padding-left:10px;">
							<%=commConfigRelationship.getInputCodeList()[i]%>
						</td>
						<td>
							<img onClick="cmdView('<%=commConfigRelationship.getItemCodeList()[i]%>')" alt="<bean:message key="comm.jsp.common.detail" bundle="conf.comm.Comm"/>" src="include/images/cmdView_s.jpg" border="0" style="cursor: hand; vertical-align: middle;" />
						</td>
						<td>
							<img onClick="cmdEdit('<%=commConfigRelationship.getItemCodeList()[i]%>')" alt="<bean:message key="comm.jsp.common.alter" bundle="conf.comm.Comm"/>" src="include/images/cmdEdit_s.jpg" border="0" style="cursor: hand; vertical-align: middle;" />
						</td>
						<td>
							<img onClick="cmdDel('<%=commConfigRelationship.getItemCodeList()[i]%>')" alt="<bean:message key="comm.jsp.common.delete" bundle="conf.comm.Comm"/>" src="include/images/cmdDel_s.jpg" border="0" style="cursor: hand; vertical-align: middle;" />
						</td>
					</tr>
					<%
						}
			...
			<table width="100%" align="center" class="tblScrollFooter">
				<tr>
					<td colspan="11" align="center" class="footer">
						...
						%>
						<input type="hidden" id="pageId" name="pageId" value="page_2828810b39763b910139763b91d90000" />
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/comm/commConfigRelationship.do?verbId=query" />
