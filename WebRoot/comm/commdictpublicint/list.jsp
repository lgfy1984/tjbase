		...
		<form name="form" method="post" action="comm/commDictPublicInt.do">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearch" align="center">
				...
				<tr>
					<td>
						...
						<input type="text" class="input" id="displayInputId_1" name="className" style="font-size: 12px; width: 180px" onkeydown="huiche()" value="<%=commDictPublicInt.getClassName()%>" readonly="readonly" onkeypress="eventOnKeyPress('hidden_1')" />
						<input type="hidden" id="hiddenInputId_1" value="<%=commDictPublicInt.getClassCode()%>" name="classCode" />
						...
						<input name="dictCode" type="text" onkeypress="eventOnKeyPress('dictValue')" value="<%=commDictPublicInt.getDictCode()%>">

						<bean:message key="jsp.dictValue" bundle="conf.Init"/>:
						<input name="dictValue" type="text" onkeypress="eventOnKeyPress('inputCode')" value="<%=commDictPublicInt.getDictValue()%>">

						<bean:message key="jsp.inputNo" bundle="conf.Init"/>:
						<input name="inputCode" type="text" onkeypress="eventOnKeyPress('<bean:message key="jsp.btnsubmit"  bundle="conf.Init" />')" value="<%=commDictPublicInt.getInputCode()%>">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearchList" align="center">
				...
				<tbody id="interval_row_id">
					...
					<tr>
						...
						<td>
							<img onClick="cmdView('<%=commDictPublicInt.getIdList()[i]%>')" alt="<bean:message key="jsp.detail" bundle="conf.Init" />" src="include/images/cmdView_s.jpg" border="0" style="cursor: hand; vertical-align: middle;" />
						</td>
						<td>
							<img onClick="cmdEdit('<%=commDictPublicInt.getIdList()[i]%>')" alt="<bean:message key="jsp.update" bundle="conf.Init" />" src="include/images/cmdEdit_s.jpg" border="0" style="cursor: hand; vertical-align: middle;" />
						</td>
						<td>
							<img onClick="cmdDel('<%=commDictPublicInt.getIdList()[i]%>')" alt="<bean:message key="jsp.delete" bundle="conf.Init" />" src="include/images/cmdDel_s.jpg" border="0" style="cursor: hand; vertical-align: middle;" />
						</td>
					</tr>
					<%
						}
			...
			<table width="100%" align="center" class="tblScrollFooter">		
				<tr>
					...
					%>
						<input type="hidden" id="pageId" name="pageId" value="page_282881f534636ed60134636ed7030000" />
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/comm/commDictPublicInt.do?verbId=query" />
