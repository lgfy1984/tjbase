	...
	<body onload="document.form.inputCode.focus();showCommMessage('','<%=data.getMessage()%>','1')">
		...
		<form name="form" method="post" action="comm/commConfigLocationGroup.do">
			...
			<table width="95%" class="table7" align="center" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td id="list_L"></td>
					<td class="list_biaoti"><bean:message key="comm.jsp.common.jm" bundle="conf.comm.Comm"/></td>
					<td id="list_C"></td>
					<td class="list_cc">						
						<bean:message key="comm.jsp.common.inputItemCode" bundle="conf.comm.Comm"/>：<input name="inputCode" type="text"
							onkeypress="eventOnKeyPress('itemCode')"
							value="<%=data.getInputCode()%>" />
					</td>
					<td class="list_cc">
						
						<bean:message key="comm.jsp.common.itemName" bundle="conf.comm.Comm"/>：<input name="itemCode" type="text"
							onkeypress="eventOnKeyPress('itemName')"
							value="<%=data.getItemCode()%>" />
					</td>
					<td class="list_cc">
						
						<bean:message key="comm.jsp.common.name" bundle="conf.comm.Comm"/>：<input name="itemName" type="text"
					...
					<td class="button">
						<input type="button"
							name="<bean:message key="comm.jsp.common.commit" bundle="conf.comm.Comm"/>" value="<bean:message key="comm.jsp.common.commit2" bundle="conf.comm.Comm"/>" onclick="submitQueryForm();" />
					</td>
				</tr>
			</table>
			...
			<table class="table" align="center" width="95%" cellspacing="1" cellpadding="0">
				<tr class="list_nav">
					<td width="150px">
						<bean:message key="comm.jsp.common.itemName" bundle="conf.comm.Comm"/><span style="margin:0;padding:0;width:7px;height:15px;display:block;position:absolute;right:5px;top:0px;">
			...
			<span style="margin:0;margin-top:5px;padding:0;width:7px;height:4px;display:block;"><img src="include/images/cmdOrderByDesc.gif" border="0" alt="<bean:message key="comm.jsp.common.down" bundle="conf.comm.Comm"/>" style="cursor: hand" onclick="commandOrderBy('1', '1')" /></span>
					...
					<td width="201px">
						<bean:message key="comm.jsp.common.name" bundle="conf.comm.Comm"/><span style="margin:0;padding:0;width:7px;height:15px;display:block;position:absolute;right:5px;top:0px;">
