...
<%}%>
<title><bean:message key="comm.jsp.common.jmz" bundle="conf.comm.Comm"/>add.jsp</title>
...
function saveForm(){
		...
		if(document.form.itemCode.value == ""){
		 	alertCommMessage("<bean:message key="comm.jsp.common.alert12" bundle="conf.comm.Comm"/>");
		 	return ;
		}
		if(isNaN(document.form.itemCode.value)){
	       alert("<bean:message key="comm.jsp.common.alert9" bundle="conf.comm.Comm"/>"); 
	       return true;
	    }
	    if(document.form.itemCode.value.length !=12){
		 	alert("<bean:message key="comm.jsp.common.alert8" bundle="conf.comm.Comm"/>");
		 	return ;
		}
