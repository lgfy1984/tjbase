...
<!--查询条件-->
<table width="95%" class="table8" align="center" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td id="list_L"></td>
		<td class="list_biaoti"><bean:message key="comm.jsp.common.village" bundle="conf.comm.Comm"/></td>
		<td id="list_C"></td>
		<td class="list_cc">			
		...
		<td class="list_cc">			
			<bean:message key="comm.jsp.common.villageItemCode" bundle="conf.comm.Comm"/>：<input name="itemCode" type="text" onkeypress="eventOnKeyPress('itemName')" value="<%=data.getItemCode()%>"/>
		</td>
		<td class="list_cc">	
			<bean:message key="comm.jsp.common.villageName" bundle="conf.comm.Comm"/>：<input name="itemName" type="text" onkeypress="eventOnKeyPress('<bean:message key="comm.jsp.common.commit" bundle="conf.comm.Comm"/>')" value="<%=data.getItemName()%>"/>
		</td>
		<td id="list_R"></td>
		<td class="button">
...
<table class="table" align="center" width="95%" cellspacing="1" cellpadding="0">
	<tr class="list_nav">
		<td width="100px">
			<bean:message key="comm.jsp.common.villageItemCode" bundle="conf.comm.Comm"/><span style="margin:0;padding:0;width:7px;height:15px;display:block;position:absolute;right:5px;top:0px;">
		...
		<td width="281px">
		    <bean:message key="comm.jsp.common.villageName" bundle="conf.comm.Comm"/><span style="margin:0;padding:0;width:7px;height:15px;display:block;position:absolute;right:5px;top:0px;">
