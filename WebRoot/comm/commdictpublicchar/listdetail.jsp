		...
		<form name="form" method="post" action="comm/commDictPublicChar.do">
			...
			<table  width="100%" align="center" class="tblScrollFooter">
				<tr>
					...
					%>
						<input type="hidden" id="pageId" name="pageId" value="page_282881f534636eb60134636eb61c0000" />
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/comm/commDictPublicChar.do?verbId=queryDetail" />
