		...
		<form name="form" method="post" action="comm/commDictPublicClass.do">
			...
			<table  width="100%" align="center" class="tblScrollFooter">
				<tr>
					...
					%>
						<input type="hidden" id="pageId" name="pageId" value="page_282881f534636e6c0134636e6e860000" />
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/comm/commDictPublicClass.do?verbId=queryDetail" />
