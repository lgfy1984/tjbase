			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearch" align="center">
				<tr>
					<td class="tblTitle" colspan="4">
						<bean:message key="comm.jsp.commconfigunittype.list.td1" bundle="conf.comm.CommMessageguoh"/>
					</td>
				</tr>
				<tr>
					<td>
						<bean:message key="comm.jsp.commconfigrh.list.td2" bundle="conf.comm.CommMessageguoh"/>
						<input name="itemCode" type="text" onkeypress="eventOnKeyPress('itemName')" value="<%=commConfigUnittype.getItemCode()%>"/>
					
						<bean:message key="comm.jsp.commconfigrh.list.td3" bundle="conf.comm.CommMessageguoh"/>
						<input name="itemName" type="text" onkeypress="eventOnKeyPress('inputCode')" value="<%=commConfigUnittype.getItemName()%>"/>
					
						<bean:message key="comm.jsp.commconfigrh.list.td4" bundle="conf.comm.CommMessageguoh"/>
						<input name="inputCode" type="text" onkeypress="eventOnKeyPress('<bean:message key="comm.jsp.commconfigrh.list.td5" bundle="conf.comm.CommMessageguoh"/>')" value="<%=commConfigUnittype.getInputCode()%>"/>
					
						<input type="button" class="btnSave" name='<bean:message key="comm.jsp.commconfigrh.list.td5" bundle="conf.comm.CommMessageguoh"/>' value='<bean:message key="comm.jsp.commconfigrh.list.td6" bundle="conf.comm.CommMessageguoh"/>' onClick="submitQueryForm();" />
					</td>
				</tr>
			</table>
			<!--列表标题-->
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearchList" align="center">
				...
				<tbody id="interval_row_id">
					...
					<tr class="list_neirong">
						<td>
							<%=commConfigUnittype.getItemCodeList()[i]%>
						</td>
						<td style="text-align:left;padding-left:10px;">
							<%=commConfigUnittype.getItemNameList()[i]%>
						</td>
						<td>
							<%=commConfigUnittype.getSeqNoList()[i]%>
						</td>
						<td style="text-align:left;padding-left:10px;">
							<%=commConfigUnittype.getInputCodeList()[i]%>
						</td>
						<td>
							<img onClick="cmdView('<%=commConfigUnittype.getItemCodeList()[i]%>')" alt='<bean:message key="comm.jsp.commconfigrh.list.img9" bundle="conf.comm.CommMessageguoh"/>' src="include/images/cmdView_s.jpg" border="0" style="cursor: hand; vertical-align: middle;" />
						</td>
						<td>
							<img onClick="cmdEdit('<%=commConfigUnittype.getItemCodeList()[i]%>')" alt='<bean:message key="comm.jsp.commconfigrh.list.img10" bundle="conf.comm.CommMessageguoh"/>' src="include/images/cmdEdit_s.jpg" border="0" style="cursor: hand; vertical-align: middle;" />
						</td>
						<td>
							<img onClick="cmdDel('<%=commConfigUnittype.getItemCodeList()[i]%>')" alt='<bean:message key="comm.jsp.commconfigrh.list.img11" bundle="conf.comm.CommMessageguoh"/>' src="include/images/cmdDel_s.jpg" border="0" style="cursor: hand; vertical-align: middle;" />
						</td>
					</tr>
					<%
						}
			...
			<table width="100%" align="center" class="tblScrollFooter">
				<tr>
					<td colspan="11" align="center" class="footer">
						...
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/comm/commConfigUnittype.do?verbId=query&isQuery=<%=request.getParameter("isQuery") %>" />
