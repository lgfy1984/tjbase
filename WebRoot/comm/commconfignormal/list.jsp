			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearchList"  align="center">
				...
				<tbody id="interval_row_id">
					...
					<tr>
						...
						<td>
							<img
								onclick="cmdEdit('<%=commConfigNormal.getItemCodeList()[i]%>')"
								alt="<bean:message key="comm.jsp.common.alter" bundle="conf.comm.Comm"/>"
								src="include/images/cmdEdit_s.jpg" border="0"
								style="cursor: hand; vertical-align: middle;" />
						</td>
						<td>
							<img
								onclick="cmdDel('<%=commConfigNormal.getItemCodeList()[i]%>')"
								alt="<bean:message key="comm.jsp.common.delete" bundle="conf.comm.Comm"/>"
			...
			<table  width="100%" align="center" class="tblScrollFooter">
				<tr>
					...
					%>
						...
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/comm/commConfigNormal.do?verbId=query" />
