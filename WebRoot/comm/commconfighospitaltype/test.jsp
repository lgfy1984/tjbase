...
<link rel="stylesheet" href="<%=request.getContextPath()%>/ciha/include/css/open.css" />
			<td class="tdRight_R" colspan="3">
				...
				<img src="<%=request.getContextPath()%>/ciha/include/images/select.gif" style="cursor:pointer;" onclick="add('<%=request.getContextPath()%>/comm/commConfigHospitalType.do?verbId=getHspType&hspTypeLevel=2','displayInputId_1','hiddenInputId_1')" />
		 	</td>