...
function saveForm(){
	...
	if(levelCode1==itemCode||levelCode2==itemCode){
		alert({message:'<bean:message key="comm.jsp.different.text29" bundle="conf.comm.comm"/>!'});
		return;
	}
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="tblFill" border="0" cellpadding="0" cellspacing="0" class="tblFill">
  ...
  <!-- Sheet operation button area -->
 	 <div class="btnSave">
		 <input type="button" style="font-size:12px;font-family:Arial;" name="btnSaveForm" value="<bean:message key="comm.jsp.common.text3" bundle="conf.comm.comm"/>" onclick="saveForm()" />
