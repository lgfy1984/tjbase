...
<table  width="100%" border="0" cellpadding="0" cellspacing="0" class="tblView" align="center">
 	<tr>
        <td  class="tblTitle" colspan="4">
          <bean:message key="comm.jsp.different.text28" bundle="conf.comm.comm"/>
        </td>
    </tr>
    <tr>
  		<td class="tblLable">
        ...
        <td class="hou">
            <%=commConfigInputDict.getItemCode() %></td>
        <td class="tblLable">
            <bean:message key="comm.jsp.common.text29" bundle="conf.comm.comm"/>：
        </td>
        <td class="hou">
        	<%=commConfigInputDict.getItemName() %>  
        </td>
    </tr>
    <tr>
        <td class="tblLable">
        ...
        <td class="hou">            
            <%=commConfigInputDict.getInputCode() %>  
        </td>
        <td class="tblLable">
            <bean:message key="comm.jsp.common.text45" bundle="conf.comm.comm"/>：
        </td>
        <td class="hou">            
             <%=commConfigInputDict.getInputCodeWb() %>      
        </td>
    </tr>
    <tr>
        <td class="tblLable">
        ...
        <td class="hou" colspan="3">
            <%=commConfigInputDict.getComments() %>      
        </td>      
    </tr>  
  </table>
