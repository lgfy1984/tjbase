		...
		<form name="form" method="post" action="comm/commConfigInputDict.do">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearchList" align="center">
				...
				<tr>
					...
					<td>
						<img onclick="cmdEdit('<%=commConfigInputDict.getItemCodeList()[i] %>')" alt="<bean:message key="comm.jsp.common.text47" bundle="conf.comm.comm"/>" src="include/images/cmdEdit_s.jpg" border="0" style="cursor:hand; vertical-align:middle;" />
					</td>
					<td>
						<img onclick="cmdDel('<%=commConfigInputDict.getItemCodeList()[i] %>')" alt="<bean:message key="comm.jsp.common.text35" bundle="conf.comm.comm"/>" src="include/images/cmdDel_s.jpg" border="0" style="cursor:hand; vertical-align:middle;" />
					</td>				
				</tr>
					<%
						}
			...
			<table width="100%" align="center" class="tblScrollFooter">	
				<tr>
					<td colspan="11" align="center" class="footer">
						...
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/comm/commConfigInputDict.do?verbId=query" />
