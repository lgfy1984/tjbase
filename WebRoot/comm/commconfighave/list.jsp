		...
		<form name="form" method="post" action="comm/commConfigHave.do">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearch" align="center">
				<tr>
					<td class="tblTitle" colspan="4">
						<bean:message key="comm.jsp.different.text62" bundle="conf.comm.comm"/>
					</td>
				</tr>
				<tr>
					<td>
						<bean:message key="comm.jsp.common.text10" bundle="conf.comm.comm"/>:<input name="itemCode" type="text"
						 onkeypress="eventOnKeyPress('itemName')"
						 value="<%=commConfigHave.getItemCode() %>" />
						 
						<bean:message key="comm.jsp.common.text29" bundle="conf.comm.comm"/>:<input name="itemName" type="text" 
						 onkeypress="eventOnKeyPress('inputCode')"
						value="<%=commConfigHave.getItemName() %>" />
		
						<bean:message key="comm.jsp.common.text38" bundle="conf.comm.comm"/>:<input name="inputCode" onkeypress="eventOnKeyPress('bstnsubmit')" type="text" value="<%=commConfigHave.getInputCode() %>" />
				
						<input type="button" class="btnSave" name="bstnsubmit" value="<bean:message key="comm.jsp.common.text401" bundle="conf.comm.comm"/>" onclick="submitQueryForm();" />
					</td>
				</tr>
			</table>
			<!--列表标题-->
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearchList" align="center">
				...
				<tr>
					...
					<td>
						<img onclick="cmdView('<%=commConfigHave.getItemCodeList()[i] %>')" alt="<bean:message key="comm.jsp.common.text46" bundle="conf.comm.comm"/>" src="include/images/cmdView_s.jpg" border="0" style="cursor:hand; vertical-align:middle;" />
					</td>
					<td>
						<img onclick="cmdEdit('<%=commConfigHave.getItemCodeList()[i] %>')" alt="<bean:message key="comm.jsp.common.text47" bundle="conf.comm.comm"/>" src="include/images/cmdEdit_s.jpg" border="0" style="cursor:hand; vertical-align:middle;" />
					</td>
					<td>
						<img onclick="cmdDel('<%=commConfigHave.getItemCodeList()[i] %>')" alt="<bean:message key="comm.jsp.common.text35" bundle="conf.comm.comm"/>" src="include/images/cmdDel_s.jpg" border="0" style="cursor:hand; vertical-align:middle;" />
					</td>				
				</tr>
				<%
						}
			...
			<table  width="100%" align="center" class="tblScrollFooter">
				<tr>
					...
					%>
						<input type="hidden" id="pageId" name="pageId" value="page_282881f534638fc20134638fc2ca0000" />
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/comm/commConfigHave.do?verbId=query" />
