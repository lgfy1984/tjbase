...
function saveForm(){
	...
	if(document.form.itemCode.value == ""){
	 	alert('<bean:message key="comm.jsp.common.text11" bundle="conf.comm.comm"/>');
	 	return ;
	}
	if(document.form.itemName.value == ""){
	 	alert('<bean:message key="comm.jsp.common.text30" bundle="conf.comm.comm"/>');
	 	return ;
	}
	//修改
...
<input type="hidden" name="verbId" value="update" />
 <table  border="0" cellpadding="0" cellspacing="0" class="tblFill" align="center">
    <tr>
         <td class="tblTitle" colspan="4"><span>※</span><bean:message key="comm.jsp.different.text57" bundle="conf.comm.comm"/><span>※</span></td>
    </tr>
    <tr>
        <td class="tblLable">
        ...
        <td>
              ...
              value="<%=commConfigHave.getItemCode() %>" readonly />
        </td>      
        <td class="tblLable">
    ...
    <tr>
     ...
     <td class="tblLable"><bean:message key="comm.jsp.common.text4" bundle="conf.comm.comm"/>:</td>
     <td>
     <input type="text" name="comments" id="address" size="50" maxlength="50" max="40" dataType="LimitB" msg="备注输入过长"
       value="<%=commConfigHave.getComments() %>"  onkeypress="eventOnKeyPress('btnSaveForm')"/>
     </td>  
    </tr>
  </table>
