		...
		<form name="form" method="post" action="comm/commConfigVocation.do">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="tblSearchList" align="center">
				...
				<tr>
					...
					<td>
						<img onclick="cmdEdit('<%=commConfigVocation.getItemCodeList()[i] %>')" alt='<bean:message key="comm.jsp.commconfigrh.list.img10" bundle="conf.comm.CommMessageguoh"/>' src="include/images/cmdEdit_s.jpg" border="0" style="cursor:hand; vertical-align:middle;" />
					</td>
					<td>
						<img onclick="cmdDel('<%=commConfigVocation.getItemCodeList()[i] %>')" alt='<bean:message key="comm.jsp.commconfigrh.list.img11" bundle="conf.comm.CommMessageguoh"/>' src="include/images/cmdDel_s.jpg" border="0" style="cursor:hand; vertical-align:middle;" />
					</td>				
				</tr>
				<%}
			}
				...
				<tr>
					<td colspan="11" align="center" class="footer">
					 <%int curPage = 0;
						...
						<input type="hidden" id="reHref" name="reHref" value="<%=request.getContextPath()%>/comm/commConfigVocation.do?verbId=query" />
