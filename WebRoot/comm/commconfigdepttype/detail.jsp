			...
			<table border="0" cellspacing="1" cellpadding="0" class="table">
				<tr>
					<td class="biaoti" colspan="4" nowrap>
						<bean:message  bundle="comm.commLocale" key="comm.jsp.commconfigdepttypedetail.text18"/>
					</td>
				</tr>
				<tr>
					...
					<td class="hou" nowrap>
						<%=commConfigDepttype.getItemCode()%>
					<td class="qian" nowrap>
						<bean:message  bundle="comm.commLocale" key="comm.jsp.commom.name"/>:
					</td>
					<td class="hou" nowrap>
						<%=commConfigDepttype.getItemName()%>
					</td>
				</tr>
				<tr>
					<td class="qian" nowrap>
				...
				<tr>
					...
					<td class="hou" nowrap>
						<%=commConfigDepttype.getComments()%>
					</td>
					<td class="qian" nowrap>
					</td>
					<td class="hou" nowrap>
