...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tblView" align="center">
 	<tr>
        <td class="tblTitle" colspan="4">
          <bean:message key="comm.jsp.commconfigyes.detail.title" bundle="conf.comm.CommMessageguoh"/>
        </td>
    </tr>
    <tr>
        ...
        <td class="tblLable"><bean:message key="comm.jsp.commconfigrh.detail.td3" bundle="conf.comm.CommMessageguoh"/>:</td>
        <td class="hou"><%=commConfigYes.getItemName() %>  
        </td>
    </tr>
