...
public class CommConfigDepttypeAction extends BaseAction {

	private ICommConfigDepttypeService commConfigDepttypeService;
	...
	public ICommConfigDepttypeService getCommConfigDepttypeService() {
		return commConfigDepttypeService;
	}

	public void setCommConfigDepttypeService(ICommConfigDepttypeService commConfigDepttypeService) {
		this.commConfigDepttypeService = commConfigDepttypeService;
	}
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDepttypeForm hosform = (CommConfigDepttypeForm) form;
			CommConfigDeptAttr checkData = commConfigDepttypeService.checkData(hosform.getItemCode());
			if (checkData != null) {
				...
				commConfigDepttypeService.addInit(hosform);
				request.setAttribute("commConfigDepttype", hosform);
				return mapping.findForward("add");
			}
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigDepttypeService.save(hosform);
			CommConfigDepttypeForm hosformNew = new CommConfigDepttypeForm();
	...
	public ActionForward query(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			int count;
			int page = 0;
			int recordCount = commConfigDepttypeService.getCount(hosform.getItemCode(), hosform.getItemName(), hosform.getInputCode(), hosform.getSeqNo());
			...
			// ////// page end ////////////////////////
			commConfigDepttypeService.getSearch(hosform, count, pageSize);
			commConfigDepttypeService.serchInit(hosform);
			request.setAttribute("commConfigDepttype", hosform);
	...
	public ActionForward updateInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDepttypeForm hosform = (CommConfigDepttypeForm) form;
			commConfigDepttypeService.updateInit(hosform);
			request.setAttribute("commConfigDepttype", hosform);
	...
	public ActionForward addInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDepttypeForm hosform = new CommConfigDepttypeForm();
			commConfigDepttypeService.addInit(hosform);
			request.setAttribute("commConfigDepttype", hosform);
			return mapping.findForward("add");
		}
	...
	public ActionForward detail(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDepttypeForm hosform = (CommConfigDepttypeForm) form;
			commConfigDepttypeService.showInit(hosform);
			request.setAttribute("commConfigDepttype", hosform);
	...
	public ActionForward update(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDepttypeForm hosform = (CommConfigDepttypeForm) form;
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigDepttypeService.update(hosform);
			CommConfigDepttypeForm hosformNew = new CommConfigDepttypeForm();
			return this.query(mapping, hosformNew, request, response);
		}
		catch (Exception e) {
	...
	public ActionForward delete(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDepttypeForm hosform = (CommConfigDepttypeForm) form;
			commConfigDepttypeService.delete(hosform);
