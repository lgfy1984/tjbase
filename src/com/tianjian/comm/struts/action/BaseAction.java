...
public class BaseAction extends Action {
	...
	protected String checkUser(HttpServletRequest request, HttpServletResponse response) {
		...
		if (userForm == null) {
			...
			SecurityStaffAliveAccessServiceImpl service = (SecurityStaffAliveAccessServiceImpl)ApplicationContextUtil.getContext().getBean("securityStaffAliveAccessService");
