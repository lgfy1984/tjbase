...
public class CommConfigDeptAction extends BaseAction {

	private ICommConfigDeptService commConfigDeptService;
	...
	public ICommConfigDeptService getCommConfigDeptService() {
		return commConfigDeptService;
	}

	public void setCommConfigDeptService(ICommConfigDeptService commConfigDeptService) {
		this.commConfigDeptService = commConfigDeptService;
	}
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDeptForm hosform = (CommConfigDeptForm) form;
			CommConfigDept checkData = commConfigDeptService.checkData(hosform.getItemCode());
			if (checkData != null) {
				...
				commConfigDeptService.addInit(hosform);
				request.setAttribute("commConfigDept", hosform);
				return mapping.findForward("add");
			}
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigDeptService.save(hosform);
			CommConfigDeptForm hosformNew = new CommConfigDeptForm();
	...
	public ActionForward query(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			int count;
			int page = 0;
			int recordCount = commConfigDeptService.getCount(hosform.getItemCode(), hosform.getItemName(), hosform.getInputCode(), hosform.getSeqNo());
			...
			// ////// page end ////////////////////////
			commConfigDeptService.getSearch(hosform, count, pageSize);
			commConfigDeptService.serchInit(hosform);
			request.setAttribute("commConfigDept", hosform);
	...
	public ActionForward updateInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDeptForm hosform = (CommConfigDeptForm) form;
			commConfigDeptService.updateInit(hosform);
			request.setAttribute("commConfigDept", hosform);
	...
	public ActionForward addInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDeptForm hosform = new CommConfigDeptForm();
			commConfigDeptService.addInit(hosform);
			request.setAttribute("commConfigDept", hosform);
			return mapping.findForward("add");
		}
	...
	public ActionForward detail(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDeptForm hosform = (CommConfigDeptForm) form;
			commConfigDeptService.showInit(hosform);
			request.setAttribute("commConfigDept", hosform);
	...
	public ActionForward update(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDeptForm hosform = (CommConfigDeptForm) form;
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigDeptService.update(hosform);
			CommConfigDeptForm hosformNew = new CommConfigDeptForm();
			return this.query(mapping, hosformNew, request, response);
		}
		catch (Exception e) {
	...
	public ActionForward delete(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigDeptForm hosform = (CommConfigDeptForm) form;
			commConfigDeptService.delete(hosform);
