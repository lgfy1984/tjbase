...
public class CommGbCoptpAction extends BaseAction {

	private ICommGbCoptpService commGbCoptpService;
	private ICommConfigInputDictService commConfigInputDictService;
	
	public ICommGbCoptpService getCommGbCoptpService() {
		return commGbCoptpService;
	}
	public void setCommGbCoptpService(
			ICommGbCoptpService commGbCoptpService) {
		this.commGbCoptpService = commGbCoptpService;
	}
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommGbCoptpForm hosform = (CommGbCoptpForm) form;
			CommGbCoptp checkData = commGbCoptpService.checkData(hosform.getItemCode());
			if (checkData != null) {
				...
				commGbCoptpService.addInit(hosform);
				request.setAttribute("commGbCoptp", hosform);
				return mapping.findForward("add");
			}
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			this.commGbCoptpService.save(hosform);
			CommGbCoptpForm hosformNew = new CommGbCoptpForm();
	...
	public ActionForward query(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			int count;
			int page = 0;
			int recordCount = commGbCoptpService.getCount(hosform.getItemCode(), hosform.getItemName(), hosform.getInputCode(), hosform.getSeqNo());
			...
			// ////// page end ////////////////////////
			commGbCoptpService.getSearch(hosform, count, pageSize);
			commGbCoptpService.serchInit(hosform);
			request.setAttribute("commGbCoptp", hosform);
	...
	public ActionForward updateInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommGbCoptpForm hosform = (CommGbCoptpForm) form;
			commGbCoptpService.updateInit(hosform);
			request.setAttribute("commGbCoptp", hosform);
	...
	public ActionForward addInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommGbCoptpForm hosform = new CommGbCoptpForm();
			commGbCoptpService.addInit(hosform);
			request.setAttribute("commGbCoptp", hosform);
			return mapping.findForward("add");
		}
	...
	public ActionForward detail(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommGbCoptpForm hosform = (CommGbCoptpForm) form;
			commGbCoptpService.showInit(hosform);
			request.setAttribute("commGbCoptp", hosform);
	...
	public ActionForward update(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommGbCoptpForm hosform = (CommGbCoptpForm) form;			
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commGbCoptpService.update(hosform);
			CommGbCoptpForm hosformNew = new CommGbCoptpForm();
			return this.query(mapping, hosformNew, request, response);
		}
		catch (Exception e) {
	...
	public ActionForward delete(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommGbCoptpForm hosform = (CommGbCoptpForm) form;
			commGbCoptpService.delete(hosform);
			CommGbCoptpForm hosformNew = new CommGbCoptpForm();
			return this.query(mapping, hosformNew, request, response);
		}
		catch (Exception e) {
