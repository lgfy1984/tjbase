...
public class CommConfigCardorgAction extends BaseAction {

	private ICommConfigCardorgService commConfigCardorgService;
	...
	public ICommConfigCardorgService getCommConfigCardorgService() {
		return commConfigCardorgService;
	}

	public void setCommConfigCardorgService(ICommConfigCardorgService commConfigCardorgService) {
		this.commConfigCardorgService = commConfigCardorgService;
	}
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigCardorgForm hosform = (CommConfigCardorgForm) form;
			CommConfigCardorg checkData = commConfigCardorgService.checkData(hosform.getItemCode());
			if (checkData != null) {
				...
				commConfigCardorgService.addInit(hosform);
				request.setAttribute("commConfigCardorg", hosform);
				return mapping.findForward("add");
			}
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigCardorgService.save(hosform);
			CommConfigCardorgForm hosformNew = new CommConfigCardorgForm();
	...
	public ActionForward query(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			int count;
			int page = 0;
			int recordCount = commConfigCardorgService.getCount(hosform.getItemCode(), hosform.getItemName(), hosform.getInputCode(), hosform.getSeqNo());
			...
			// ////// page end ////////////////////////
			commConfigCardorgService.getSearch(hosform, count, pageSize);
			commConfigCardorgService.serchInit(hosform);
			request.setAttribute("commConfigCardorg", hosform);
	...
	public ActionForward updateInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigCardorgForm hosform = (CommConfigCardorgForm) form;
			commConfigCardorgService.updateInit(hosform);
			request.setAttribute("commConfigCardorg", hosform);
	...
	public ActionForward addInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigCardorgForm hosform = new CommConfigCardorgForm();
			commConfigCardorgService.addInit(hosform);
			request.setAttribute("commConfigCardorg", hosform);
			return mapping.findForward("add");
		}
	...
	public ActionForward detail(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigCardorgForm hosform = (CommConfigCardorgForm) form;
			commConfigCardorgService.showInit(hosform);
			request.setAttribute("commConfigCardorg", hosform);
	...
	public ActionForward update(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigCardorgForm hosform = (CommConfigCardorgForm) form;
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigCardorgService.update(hosform);
			CommConfigCardorgForm hosformNew = new CommConfigCardorgForm();
			return this.query(mapping, hosformNew, request, response);
		}
		catch (Exception e) {
	...
	public ActionForward delete(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigCardorgForm hosform = (CommConfigCardorgForm) form;
			commConfigCardorgService.delete(hosform);
