...
public class CommConfigUnitgradeAction extends BaseAction {

	private ICommConfigUnitgradeService commConfigUnitgradeService;
	...
	public ICommConfigUnitgradeService getCommConfigUnitgradeService() {
		return commConfigUnitgradeService;
	}

	public void setCommConfigUnitgradeService(ICommConfigUnitgradeService commConfigUnitgradeService) {
		this.commConfigUnitgradeService = commConfigUnitgradeService;
	}
	...
	public ActionForward add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigUnitgradeForm hosform = (CommConfigUnitgradeForm) form;
			CommConfigUnitgrade checkData = commConfigUnitgradeService.checkData(hosform.getItemCode());
			if (checkData != null) {
				...
				commConfigUnitgradeService.addInit(hosform);
				request.setAttribute("commConfigUnitgrade", hosform);
				return mapping.findForward("add");
			}
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigUnitgradeService.save(hosform);
			CommConfigUnitgradeForm hosformNew = new CommConfigUnitgradeForm();
	...
	public ActionForward query(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			int count;
			int page = 0;
			int recordCount = commConfigUnitgradeService.getCount(hosform.getItemCode(), hosform.getItemName(), hosform.getInputCode(), hosform.getSeqNo());
			...
			// ////// page end ////////////////////////
			commConfigUnitgradeService.getSearch(hosform, count, pageSize);
			commConfigUnitgradeService.serchInit(hosform);
			request.setAttribute("commConfigUnitgrade", hosform);
	...
	public ActionForward updateInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigUnitgradeForm hosform = (CommConfigUnitgradeForm) form;
			commConfigUnitgradeService.updateInit(hosform);
			request.setAttribute("commConfigUnitgrade", hosform);
	...
	public ActionForward addInit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigUnitgradeForm hosform = new CommConfigUnitgradeForm();
			commConfigUnitgradeService.addInit(hosform);
			request.setAttribute("commConfigUnitgrade", hosform);
			return mapping.findForward("add");
		}
	...
	public ActionForward detail(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigUnitgradeForm hosform = (CommConfigUnitgradeForm) form;
			commConfigUnitgradeService.showInit(hosform);
			request.setAttribute("commConfigUnitgrade", hosform);
	...
	public ActionForward update(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigUnitgradeForm hosform = (CommConfigUnitgradeForm) form;
			hosform.setInputCode(commConfigInputDictService.getInputCode(hosform.getItemName()));
			commConfigUnitgradeService.update(hosform);
			CommConfigUnitgradeForm hosformNew = new CommConfigUnitgradeForm();
			return this.query(mapping, hosformNew, request, response);
		}
		catch (Exception e) {
	...
	public ActionForward delete(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			CommConfigUnitgradeForm hosform = (CommConfigUnitgradeForm) form;
			commConfigUnitgradeService.delete(hosform);
