...
public class CommConfigUnittypeForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -8035066308173782343L;
	// Fields
	...
	public CommConfigUnittypeForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
