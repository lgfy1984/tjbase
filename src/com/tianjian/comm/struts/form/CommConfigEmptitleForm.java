...
public class CommConfigEmptitleForm  extends ActionForm implements Serializable{
	
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6140893065151388536L;
	// Fields
	...
	public CommConfigEmptitleForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
