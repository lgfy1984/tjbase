...
public class CommConfigUnitgradeForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 5571309048942824785L;
	// Fields
	...
	public CommConfigUnitgradeForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
	...
	public CommConfigUnitgradeForm() {
		super();
		this.itemCode ="";
		this.itemName = "";
		this.inputCode = "";
