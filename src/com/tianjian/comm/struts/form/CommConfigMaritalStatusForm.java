...
public class CommConfigMaritalStatusForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 7449054197674863829L;
	// Fields
	...
	public CommConfigMaritalStatusForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
	...
	public CommConfigMaritalStatusForm() {
		super();
		this.itemCode ="";
		this.itemName = "";
		this.inputCode = "";
