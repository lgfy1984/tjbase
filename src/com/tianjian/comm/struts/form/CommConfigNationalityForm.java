...
public class CommConfigNationalityForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1468041855055700524L;
	// Fields
	...
	public CommConfigNationalityForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
	...
	public CommConfigNationalityForm() {
		super();
		this.itemCode ="";
		this.itemName = "";
		this.inputCode = "";
