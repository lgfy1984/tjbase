...
public class CommConfigSystemtypeForm  extends ActionForm implements Serializable{
	...
	public CommConfigSystemtypeForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
	...
	public CommConfigSystemtypeForm() {
		super();
		this.itemCode ="";
		this.itemName = "";
		this.inputCode = "";
