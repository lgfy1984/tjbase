...
public class CommConfigClinicattrForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -8586787540438251479L;
	// Fields
	...
	public CommConfigClinicattrForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
	...
	public CommConfigClinicattrForm() {
		super();
		this.itemCode ="";
		this.itemName = "";
		this.inputCode = "";
