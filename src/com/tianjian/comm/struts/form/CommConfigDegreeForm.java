...
public class CommConfigDegreeForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1087243272014647217L;
	// Fields
	...
	public CommConfigDegreeForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
