...
public class CommConfigProfessionForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -6432970057426731089L;
	// Fields
	...
	public CommConfigProfessionForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
	...
	public CommConfigProfessionForm() {
		super();
		this.itemCode ="";
		this.itemName = "";
		this.inputCode = "";
