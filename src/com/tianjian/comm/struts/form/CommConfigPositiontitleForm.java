...
public class CommConfigPositiontitleForm  extends ActionForm implements Serializable{
	...
	public CommConfigPositiontitleForm() {
		this.itemCode ="";
		this.itemName = "";
		this.inputCode = "";
		this.comments = "";
	...
	public CommConfigPositiontitleForm(String itemCode, String seqNo,
