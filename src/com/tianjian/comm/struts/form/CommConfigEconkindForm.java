...
public class CommConfigEconkindForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2863841806512563940L;
	// Fields
	...
	public CommConfigEconkindForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
