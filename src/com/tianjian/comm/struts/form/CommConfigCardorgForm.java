...
public class CommConfigCardorgForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -1572508864331826399L;
	// Fields
	...
	public CommConfigCardorgForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
