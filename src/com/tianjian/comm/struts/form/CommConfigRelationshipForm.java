...
public class CommConfigRelationshipForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 5246510849430860344L;
	// Fields
	...
	public CommConfigRelationshipForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
	...
	public CommConfigRelationshipForm() {
		super();
		this.itemCode ="";
		this.itemName = "";
		this.inputCode = "";
