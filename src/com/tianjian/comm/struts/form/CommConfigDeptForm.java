...
public class CommConfigDeptForm  extends ActionForm implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5285000578964090401L;
	// Fields
	...
	public CommConfigDeptForm(String itemCode, String itemName, String inputCode, String comments, String seqNo) {
		super();
