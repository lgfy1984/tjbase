...
public class CommConfigStafftypeServiceImpl implements ICommConfigStafftypeService {
	private static final Logger log = LogManager.getLogger(CommConfigStafftypeServiceImpl.class);
	...
	public void setCommConfigStafftypeDAO(ICommConfigStafftypeDAO commConfigStafftypeDAO) {
	...
	public CommConfigStafftype checkDataByName(String itemName){
		CommConfigStafftype data = commConfigStafftypeDAO.findByItemName(itemName);
		return data;
	}
	/**提交保存*/
	...
	public void updateInit(CommConfigStafftypeForm form){
		CommConfigStafftype data = commConfigStafftypeDAO.findById(form.getItemCodeHidden());
	...
	public int getCount(String itemCode, String itemName, String inputCode, String seqNo){
		return commConfigStafftypeDAO.getCount(itemCode, itemName, inputCode, seqNo);
	}
	/**根据查询条件获取当前显示页的数据*/
