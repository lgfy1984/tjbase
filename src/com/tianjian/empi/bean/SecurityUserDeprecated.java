...
public class SecurityUserDeprecated implements java.io.Serializable {
	...
	/** default constructor */
	public SecurityUserDeprecated() {
	}

	/** minimal constructor */
	public SecurityUserDeprecated(String id) {
		this.id = id;
	}

	/** full constructor */
	public SecurityUserDeprecated(String id, String pmi, String name,
			...
			String ccltName, String cclvName, String doorNo,String censusDoorNo,String birthDoorNo,
