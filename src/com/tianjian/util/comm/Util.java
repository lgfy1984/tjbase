...
public class Util {
	 ...
	 */
	public static String getAsciiString(int digit) throws UnsupportedEncodingException {
		byte ret[] = new byte[1];
		ret[0] = (byte) digit;
		return new String(ret, 0, ret.length, "UTF8");
	}

	public static int getAsciiNum(String s) throws UnsupportedEncodingException {
		if (s.length() < 1) {
			return 0;
		}
		byte b = s.getBytes("UTF8")[0];
		return b;
	}

	/**
	 * 字符串转换成ASCII字符码，汉字字母均可
	 * @param content
	 * @return
	 */
	 ...
	 * @return
	 */
	public static String asciiToString(String content) {
	...
	public static String[] getPagesign(Locale locale) {
		String[] pagessign = { Messages.getMessage(locale, "pages.first"), Messages.getMessage(locale, "pages.previous"), Messages.getMessage(locale, "pages.next"), Messages.getMessage(locale, "pages.end") };
		return pagessign;
	}
	...
	public static void main(String[] args) {
		...
		t = hash("chenfeichenfeichenfeichenfeichenfeichenfeichenfeichenfeichenfeichenfeichenfeichenfeichenfei");
