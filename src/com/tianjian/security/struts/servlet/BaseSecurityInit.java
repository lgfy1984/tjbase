...
public class BaseSecurityInit {
	
	private static HashMap<String, String> tjProperty;
	
	public BaseSecurityInit() {
    ...
    private static void strageMsg() {
        ...
        try {
            p.load((com.tianjian.security.struts.servlet.BaseSecurityInit.class).getClassLoader().getResourceAsStream("/conf/basesecurity/SecurityInit.properties"));
