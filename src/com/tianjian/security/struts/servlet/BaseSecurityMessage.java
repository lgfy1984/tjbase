...
public class BaseSecurityMessage {
	
	private static HashMap<String, String> tjMsg;
	
	public BaseSecurityMessage() {
    ...
    private static void strageMsg() {
        ...
        try {
            p.load((com.tianjian.security.struts.servlet.BaseSecurityMessage.class).getClassLoader().getResourceAsStream("/conf/basesecurity/SecurityMessage_zh.properties"));
