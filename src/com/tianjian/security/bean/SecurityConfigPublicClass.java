...
public class SecurityConfigPublicClass implements java.io.Serializable {
	...
	private com.tianjian.security.bean.SecurityConfigPublicClass securityConfigPublicClassObject;

	// Constructors

	public com.tianjian.security.bean.SecurityConfigPublicClass getSecurityConfigPublicClassObject() {
		return securityConfigPublicClassObject;
	}

	public void setSecurityConfigPublicClassObject(
			com.tianjian.security.bean.SecurityConfigPublicClass securityConfigPublicClassObject) {
